...
export const DEFAULT_NAVIGATION_MENU_ITEMS: NavigationMenuDefaultItem[] = [
  ...
  { label: "Curated Essentials", href: "/category/essentials#shop", displayOrder: 5, isActive: true },
  { label: "My Account", href: "/my-account", displayOrder: 6, isActive: true },
  { label: "About Ananthala", href: "/about", displayOrder: 7, isActive: true },
  { label: "Blog", href: "/blog", displayOrder: 8, isActive: true },
  { label: "Search", href: "/search", displayOrder: 9, isActive: true },
]

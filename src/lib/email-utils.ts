 ...
 * This ensures the logo displays in emails regardless of email client settings
 * Base64 embedding prevents images from being blocked by email filters
 */
...
/**
 * Alternative: Use a minimal inline SVG logo if you want to avoid large Base64
 * Uncomment this if Base64 size is an issue
 */
